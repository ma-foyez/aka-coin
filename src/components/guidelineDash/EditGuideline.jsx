...
import { deletePreviewImage, getSingleGuideline, handleChangeGuidelineInput, handleStoreGuideline, handleUpdateGuideline } from './_redux/Action/GuidelineAction';
...
const EditGuideline = () => {
    ...
    const { guidelineInput, isSubmitting , isLoading} = useSelector((state) => state.GuidelineReducer);
    ...
    const handleSubmit = (e) => {
        dispatch(handleUpdateGuideline(guidelineInput, id, navigate))
        e.preventDefault()
    };

    useEffect(() => {
        dispatch(getSingleGuideline(id))
    }, [id, dispatch])
        ...
        <DashboardLayout title="Wallet">
            <div className="card p-4">
                <div className="card-headers">
                    <h3 className="card-title">Edit Guideline</h3>
                ...
                </div>
                {
                    isLoading && (
                        <div className="d-flex justify-content-center mt-4">
                            <SimpleLoading title="Loading Guideline Input Data" />
                        </div>
                    )
                }
                <form
